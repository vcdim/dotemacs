...
** centaur-tabs
   #+begin_src elisp
	 ...
	 "`centaur-tabs-buffer-groups' control buffers' group rules.
      ...
      Group centaur-tabs with mode if buffer is derived from `eshell-mode' `elisp-mode' `dired-mode' `org-mode' `magit-mode'.
...
***** 待办事项状态
	...
	(setq org-todo-keywords
	      '((sequence "TODO" "NEXT" "|" "DONE" "DEPRECATED")))
	(setq org-todo-keyword-faces
	  '(("TODO" . (:foreground "red" :weight bold))
	    ("NEXT" . "#E35DBF")
	    ("DONE" . (:foreground "#1AA260" :weight bold))
	    ("DEPRECATED" . (:foreground "#888888")))
	  )
      #+end_src
***** 字体
      #+begin_src elisp
