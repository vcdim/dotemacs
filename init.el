...
(defun my/default-mode-font()
  ...
  (setq chinese-font-size 16.0)
  (set-face-attribute 'default nil :font (font-spec :family "MesloLGS NF" :size 14.0))
  ...
  (set-fontset-font t 'symbol (font-spec :family "Apple Color Emoji" :size 12.0) nil 'prepend)
  )
...
(defun my/org-mode-font()
  ...
  (setq chinese-font-size 16.0)
  (set-face-attribute 'default nil :font (font-spec :family "CMU Typewriter Text" :size 15.0))
  (set-fontset-font t 'kana (font-spec :family chinese-font :size chinese-font-size))
  (set-fontset-font t 'han (font-spec :family chinese-font :size chinese-font-size))
  (set-fontset-font t 'cjk-misc (font-spec :family chinese-font :size chinese-font-size))
  (set-fontset-font t 'bopomofo (font-spec :family chinese-font :size chinese-font-size))
...
(defun my/prog-mode-font()
  ...
  (setq chinese-font-size 16.0)
  (set-face-attribute 'default nil :font (font-spec :family "Iosevka" :size 15.0))
  (set-fontset-font t 'kana (font-spec :family chinese-font :size chinese-font-size))
  (set-fontset-font t 'han (font-spec :family chinese-font :size chinese-font-size))
  (set-fontset-font t 'cjk-misc (font-spec :family chinese-font :size chinese-font-size))
  (set-fontset-font t 'bopomofo (font-spec :family chinese-font :size chinese-font-size))
...
(setq org-refile-targets
      '((nil :maxlevel . 9)
        (("~/SynologyDrive/org/archive/email_archive.org"
          "~/SynologyDrive/org/archive/tasks_archive.org"
	  "~/SynologyDrive/org/archive/web_archive.org") :maxlevel . 1)
        (("~/SynologyDrive/Study/"
          "~/SynologyDrive/Work/"
